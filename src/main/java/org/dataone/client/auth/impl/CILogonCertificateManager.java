package org.dataone.client.auth.impl;
 ...
 */
public class CILogonCertificateManager {
	
	private static Log log = LogFactory.getLog(CILogonCertificateManager.class);
    ...
    private static CILogonCertificateManager cm = null;
    ...
    /**
     * CILogonCertificateManager is a singleton, so use getInstance() to get it.
     */
    private CILogonCertificateManager() {
    	try {
    ...
    /**
     * Return the singleton instance of this CILogonCertificateManager, creating it if needed.
     * @return an instance of CILogonCertificateManager
     */
    public static CILogonCertificateManager getInstance() {
        if (cm == null) {
            cm = new CILogonCertificateManager();
        }
        return cm;
    }
    ...
    /**
     * Use this method to set the certificate to point CILogonCertificateManager to
